...
describe('#UploadHandler test suite', () => {
    ...
    describe('#onFile', () => {
        test('given a stream file it should save it on disk', async () => {
            const chucks = ['key', 'dude']
            const downloadsFolder = 'C:\\tmp'
            ...
            const params = {
                fieldname: 'video',
                file: TestUtil.generateReadableStream(chucks),
                filename: 'mockFile.mov'
            }

            await handler.onFile(...Object.values(params))

            expect(onData.mock.calls.join()).toEqual(chucks.join())
            expect(onTransform.mock.calls.join()).toEqual(chucks.join())
    ...
    describe('#handleFileBytes', () => {
        test('should call emit function and it is a transform stream', async () => {
            ...
            // se o handleFileBytes for um transform stream, o pipeline
            // continua o processo, passando os dados para frente e 
